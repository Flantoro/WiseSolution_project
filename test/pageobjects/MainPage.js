...
class MainPage {
    ...
    get inputFieldButton () { return $("[class='flex-1'][data-target='qbsearch-input.inputButtonText']") }
    get inputField () {return $("[name='query-builder-test']")}
    get pricingButton () { return $("nav [href='/pricing']") }
    get bottomText () { return $("[class='h2-mktg mb-5']") }
    get bottomLink () { return $("[href='/organizations/enterprise_plan?ref_cta=Start+a+free+enterprise+trial&ref_loc=Home+campaign+hero&ref_page=%2F']") }
    get subscribeBottomButton () { return $("[class='btn-mktg mb-4 btn-muted-mktg']") }
