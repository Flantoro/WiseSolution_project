...
class SignUpPage {
    ...
    get welcomeText () { return $("[data-target='typing-effect.content']") }
    get emailInputField () { return $("[id='email']") }
    get emailContinueButton () { return $("[data-continue-to='password-container']") }
    get passwordInputField () { return $("[id='password']") }
    get passwordContinueButton () { return $("[data-continue-to='username-container']") }
    get usernameInputField () { return $("[id='login']") }
    get usernameContinueButton () { return $("[data-continue-to='opt-in-container']") }
    get emailNotificationCheckbox () { return $("[class='color-fg-on-emphasis f4 text-mono text-normal position-relative pl-2']") }
    get emailNotificationContinueButton () { return $("[data-continue-to='captcha-and-submit-container']") }
